...
import numpy as np
import pandas as pd
from src.eval_model import MSE, RMSE, R2Score
...
def evaluate_model(model: RegressorMixin, x_test: pd.DataFrame, y_test: pd.Series) -> Tuple[Annotated[float, "r2_score"], Annotated[float, "rmse"]]:
